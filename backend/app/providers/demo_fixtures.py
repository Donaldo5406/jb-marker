...
def load_demo_video() -> bytes:
    """시연용 실 Veo 광고 footage(mp4) 바이트. base64 텍스트를 디코드, 부재 시 still 폴백."""
    try:
        with open(_DEMO_VIDEO_B64, "rb") as f:
            import base64
