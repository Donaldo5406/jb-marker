...
const GATES = [
  { id: "V1", label: "콘티", desc: "스토리보드(콘티) 생성 확인을 자동 통과" },
  { id: "V2a", label: "촬영", desc: "footage 생성 확인을 자동 통과" },
  { id: "V2b", label: "카피", desc: "카피 생성 확인을 자동 통과" },
  { id: "V2c", label: "브랜드", desc: "브랜드 적용 확인을 자동 통과" },
  { id: "V3", label: "Final", desc: "최종 합성 확인을 자동 통과" },
];
...
/** 영상 스킵 스코프 — 단계별 confirm 게이트를 자동 통과할지 선택(DesignSettings 미러). */
export function VideoSettings({ bypass, onToggle }: VideoSettingsProps) {
  return (
