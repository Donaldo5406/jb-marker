...
vi.mock("../FabricEditor", () => ({ FabricEditor: () => <div data-testid="fabric" /> }));

const f = (path: string, content = "") => ({ path, content, mime: null, dirty: false });

describe("FileContent", () => {
  // MarkdownView/CodeView/FabricEditor는 next/dynamic으로 비동기 로드되므로 findBy로 대기한다
